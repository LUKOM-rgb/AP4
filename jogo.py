...
if os.path.exists(imagem):
    ...
    canvas.create_text(300, 150, text="⚠", font=("Arial", 48), fill="white")
canvas.pack()
...
for star in stars:
    star_label = Label(rating_frame, text=star, font=("Arial", 20), bg="#2C2C2C", fg="yellow")
    star_label.pack(side="left")



rating_label = Label(rating_frame, text=f"{rating} / 5", font=("Arial", 20), bg="#2C2C2C", fg="white")
...
description_title = Label(right_frame, text="Descrição", font=("Arial", 16), bg="#2C2C2C", fg="white")
...
# Reviews
review_title = Label(main_frame, text="Reviews:", font=("Arial", 16), bg="#2C2C2C", fg="white")
...
for review in reviews:
    review_label = tk.Label(reviews_frame, text=review, font=("Arial", 12), bg="black", fg="white", anchor="w")
